...
int ransac_fmatrix_make(  int *inliers, gsl_matrix *f, gsl_matrix *a, gsl_matrix *b,  int n_iters, double tol, int min_ninliers );
int ransac_reconstruct(  int *inliers,  gsl_matrix *points, gsl_matrix *projs1, gsl_matrix *projs2, gsl_matrix *k,  int n_iters, double tol, int fmatrix_mininliers );
